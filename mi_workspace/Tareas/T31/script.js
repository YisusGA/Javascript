...
function mostrarDatos(event) { // Función para mostrar los datos introducidos dentro del elemento txtResultado
    ...
    const tipoSeleccionado = document.querySelector('input[name="tipo"]:checked'); // Almacenamos el elemento radio del formulario como una variable que almacena el valor de lo que esté seleccionado y si está o no seleccionado algo
